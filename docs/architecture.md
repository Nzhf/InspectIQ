...
| **alert-service** | `8083` | Periodically checks yield/defect metrics (by calling analytics-service or querying directly) and sends Telegram notifications when configurable thresholds are violated. |
